...
window.addEventListener('load', () => {
  ...
  document.getElementById('approve-cookies-button').addEventListener('click', () => {
    window.localStorage.setItem('cookieAccepted', true);
    cookiePopup.classList.add('cookie-popup-accepted');
  });

  document.getElementById('decline-cookies-button').addEventListener('click', () => {
  ...
  if (window.location.pathname.includes('/privacy-policy')) {
    if (window.location.hash) {
      const top = document.getElementById('cookies-section').scrollIntoView();
    }
  }
});
